...
export const Card = ({ title, price, description }: CardProps) => {
  return (
    <div className="h-120 w-100 rounded-4xl overflow-hidden relative">
      ...
      <div className="bg-tertiary rounded-4xl absolute top-3 left-3 right-3 bottom-3">
        ...
        <button
          ...
          className="bg-brand-bg py-2 px-5 rounded-full text-zinc-900 font-aeonik font-bold text-2xl absolute bottom-6 left-1/2 -translate-x-1/2 cursor-pointer z-10 text-nowrap"
        >
          COMPRE AGORA
        </button>
      </div>
